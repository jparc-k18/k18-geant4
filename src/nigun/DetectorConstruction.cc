...
MaterialList* DetectorConstruction::DefineMaterial()
{
...
void DetectorConstruction::MakeField()
{
...
void DetectorConstruction::ConstructQ1(G4VPhysicalVolume *pMother)
{
...
void DetectorConstruction::ConstructQ2(G4VPhysicalVolume *pMother)
{
...
void DetectorConstruction::ConstructD1(G4VPhysicalVolume *pMother)
{
...
void DetectorConstruction::MakePositionDetector(G4VPhysicalVolume *pMother)
{
  ...
  // Material
  G4Material *DCuAreaMater = mList_->Vacuum;//Ar80IsoButane20Gas;
  G4Material *DCAreaMater = mList_->Vacuum;//Ar50Ethane50Gas;
  G4Material *DCLayerMater = mList_->Ar80IsoButane20Gas;
  G4Material *DCuboxMater  = mList_->Vacuum;//Mylar;
  G4Material *DCboxMater  = mList_->Vacuum;//Mylar;

  G4double DCuAreaX = 1000.0;//mm
  G4double DCuAreaY = 1000.0;//mm
  G4double DCuAreaZ = 120.0;//mm
  G4double DCuBoxX = 1100.0;//mm
  G4double DCuBoxY = 1100.0;//mm
  G4double DCuBoxZ = 120.01;//mm
  ...
  lnum_bc1 = geomMan.GetDetectorId("BC1-v-2");
  ...
  char Bc1Name[6][100] = {"BC1-x-1", "BC1-v-1", "BC1-u-1", "BC1-x-2", "BC1-v-2", "BC1-u-2"};
  ...
  char Bc2Name[6][100] = {"BC2-v-1", "BC2-u-1", "BC2-x-1", "BC2-v-2", "BC2-u-2", "BC2-x-2"};
  ...
  G4double DCAreaZ = 120;//mm
  G4double DCBoxX = 2100;//mm
  G4double DCBoxY = 1100;//mm
  G4double DCBoxZ = 120.01;//mm
...
//   posBc3G1.rotateZ(bendAngleD*degree);
  lnum_bc3 = geomMan.GetDetectorId("BC3-u-1");
...
//   posBc3G2.rotateZ(bendAngleD*degree);
  ...
  char Bc3Name[6][100] = {"BC3-x-1", "BC3-x-2", "BC3-v-1", "BC3-v-2", "BC3-u-1", "BC3-u-2"};

  G4VPhysicalVolume *physBc3Layer[6];
  for (int i=0; i<6; i++) {
...
//     posBc3L1.rotateZ(bendAngleD*degree);
  ...
  G4int lnum_bc4;
  lnum_bc4 = geomMan.GetDetectorId("BC4-v-2");
...
//   posBc4G1.rotateZ(bendAngleD*degree);
  lnum_bc4 = geomMan.GetDetectorId("BC4-x-1");
...
//   posBc4G2.rotateZ(bendAngleD*degree);
  ...
  char Bc4Name[6][100] = {"BC4-v-1", "BC4-v-2", "BC4-u-1", "BC4-u-2", "BC4-x-1", "BC4-x-2"};
...
//     posBc4L1.rotateZ(bendAngleD*degree);
    ...
    physBc4Layer[i] =
      new G4PVPlacement( 0, G4ThreeVector( posBc4L1D*mm, 0.0*mm, 0.0*mm ),
			 Bc4Name[i], logBc4Layer, physBc4Area, false,  119+i );
  }
  ...
  G4Material *HeBagMater[7]={mList_->Vacuum,//HeGas,//0
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void DetectorConstruction::MakeSlits(G4VPhysicalVolume *pMother)
{
...
void DetectorConstruction::MakeTOFCounter(G4VPhysicalVolume *pMother)
{
...
void DetectorConstruction::MakeAerogelCounter(G4VPhysicalVolume* pMother){
...
void DetectorConstruction::MakeWaterCounter(G4VPhysicalVolume* pMother){
