...
#ifndef DetectorConstructionStsGas_h
#define DetectorConstructionStsGas_h 1
...
class DetectorConstructionStsGas : public G4VUserDetectorConstruction
{
  public:
  
    DetectorConstructionStsGas();
   ~DetectorConstructionStsGas();
