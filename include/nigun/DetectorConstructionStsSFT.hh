...
#ifndef DetectorConstructionStsSFT_h
#define DetectorConstructionStsSFT_h 1
...
class DetectorConstructionStsSFT : public G4VUserDetectorConstruction
{
  public:
  
    DetectorConstructionStsSFT();
   ~DetectorConstructionStsSFT();
