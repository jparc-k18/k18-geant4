                         ...
                         const ThreeVector & Pin, const ThreeVector & Pout )
{
  ...
  return ThreeVector( 0.5*(x1+x2), 0.5*(y1+y2), z );
				...
				const ThreeVector & Pout )
{
  ...
  return ThreeVector( xi+ui*z, yi+vi*z, z );
}
 ...
 */
const double TARGETcenter=34.5;	
const double TARGEThw=122.2/2.0;
const double TARGETradius=67.8/2.0;
const double TARGETcenterX=8.5;
